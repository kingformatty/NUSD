...
EXPERIMENT_BRIEF = ('jinhan/grad_alpha/beta_'+str(beta)+'/jinhan_grad_disent_etdnn_small'
...
EXPERIMENT_DETAILS['SUB_DIR'] = ('jinhan/grad_alpha/beta_'+str(beta)+'/jinhan_grad_disent_etdnn_small'
                                + '_feat_'+EXPERIMENT_DETAILS["FEATURE_EXP"]
                                + '_dim_'+str(EXPERIMENT_DETAILS["FEATURE_DIMENSIONS"])
                                + '_batch_'+str(EXPERIMENT_DETAILS['BATCH_SIZE'])
                                + '_lr_'+str(EXPERIMENT_DETAILS['LEARNING_RATE'])
...
WORKSPACE_FILES_DIR = '/home/vijaysumaravi/Documents/code/vijay_depression_2020/model_arch/classification_depaudionet'
LABELS_FOLDER='/home/vijaysumaravi/Documents/database/daic-woz-old/labels/'
